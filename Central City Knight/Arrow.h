...
public:
    ...
    void draw_arrow()
    {
        ...
        glBegin(GL_POLYGON);
        glColor3f(0.043, 0.0, 0.0);
        glVertex3f(0.0, -0.11, 0);
        glVertex3f(0.060, -0.17, 0);
        glVertex3f(0.0, 0.25, 0);
        glEnd();

        glBegin(GL_POLYGON);
        glColor3f(0.074, 0.286, 0.078);
        glVertex3f(-0.0, -0.11, 0);
        glVertex3f(-0.060, -0.17, 0);
        glVertex3f(-0.0, 0.25, 0);
        glEnd();
